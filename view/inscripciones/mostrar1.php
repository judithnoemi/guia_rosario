...
<body>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Anticoncepcion</h4>
										...
										<div class="table-responsive">
											<table id="add-row" class="display table table-striped table-hover">
												<thead>
													...
													<th>Atencion</th>
													<th>Orientacion</th>
													<th>Metodos_Anticoncepcion_Modernos</th>
													<th>Insumos</th>
													<th>Metodos_Naturales</th>
													<th>Muestras_Pap_Tomadas</th>
													<th>Estado</th>
                                            ...
                                            <tbody>
													...
													?>
															<tr>
															<td><?php echo $row['idanticoncepcion']; ?></td>
															<td><?php echo $row['nombrep']." ".$row['apellidop']; ?></td>
															<td><?php echo $row['nomdoc']." ".$row['apedoc']; ?></td>
															<td><?php echo $row['nombrees']; ?></td>
															<td><?php echo $row['fechaan']; ?></td>
															<td><?php echo $row['registroan']; ?></td>
															<td><?php echo $row['detallean']; ?></td>
															<td><?php echo $row['atencionan']; ?></td>
															<td><?php echo $row['orientacion']; ?></td>
															<td><?php echo $row['metodosantimode']; ?></td>
															<td><?php echo $row['insumos']; ?></td>
															<td><?php echo $row['metodosnat']; ?></td>
															<td><?php echo $row['muestraspaptom']; ?></td>
					                                    <td>
																	<?php if ($row['estado'] == 1) { ?>
																		<form method="get" action="javascript:activo('<?php echo $row['idanticoncepcion']; ?>')">
																			<button type="submit" class="btn btn-success btn-xs">Activo</button>
																		</form>

																	<?php  } else { ?>
																		<form method="get" action="javascript:inactivo('<?php echo $row['idanticoncepcion']; ?>')">
																...
																<td>
																	...
																	<div class="form-button-action">
																		<button href="#editRowModal=<?php echo $row['idanticoncepcion']; ?>" class="btn btn-link btn-primary btn-lg" data-toggle="modal" title="" data-original-title="Edit Task" data-target="#editRowModal<?php echo $row['idanticoncepcion']; ?>">
																			<i class="fa fa-edit"></i>
																		</button>
														

																		<button href="#deleteRowModal=<?php echo $row['idanticoncepcion']; ?>" class="btn btn-link btn-danger btn-lg" data-toggle="modal" title="" data-original-title="Delete Task" data-target="#deleteRowModal<?php echo $row['idanticoncepcion']; ?>">
	...
	if (isset($_POST["agregar"])) {
		...
		$sql = "SELECT * FROM anticoncepcion where idanticoncepcion='$idanticoncepcion'";
	...
	?>
		...
		?>
			...
			$sql2="INSERT INTO anticoncepcion (codpaci, coddoc, fechaan, registroan, detallean, atencionan, orientacion, metodosantimode, insumos, metodosnat, muestraspaptom, estado) 
			VALUES ('$codpaci', '$coddoc', '$fechaan', '$registroan', '$detallean', '$atencionan', '$orientacion', '$metodosantimode', '$insumos', '$metodosnat', '$muestraspaptom', '1');";	 
				...
				?>
					...
					<script type="text/javascript">
						Swal.fire({
							...
							window.location = "../folder/anticoncepcion.php";
						});
					</script>
