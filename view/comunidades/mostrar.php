...
<body>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
											<a href="../../view/historia/busqueda.php">
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="../view/comunidades/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
											...
											<table id="add-row" class="display table table-striped table-hover">
												...
												<tbody>
													...
													foreach ($dato as $key => $value) {
														foreach ($value as $va) { ?>
															<tr>
																<td><?php echo $va['id_comunidad']; ?></td>
																<td><?php echo $va['nombre_comunidad']; ?></td>
																<td><?php echo $va['provincia']; ?></td>


																<td>
																	<div class="form-button-action">

																		<a href="#editRowModal_<?php echo $va["id_comunidad"]; ?>" title="Editar" data-backdrop="false" class="btn btn-link btn-primary btn-lg" data-toggle="modal"><i class="fa fa-edit"></i></a>

																		<button href="#deleteRowModal=<?php echo $va['id_comunidad']; ?>" class="btn btn-link btn-danger btn-lg" data-toggle="modal" title="" data-original-title="Delete Task" data-target="#deleteRowModal
						<?php echo $va['id_comunidad']; ?>">
    ...
    // Agrega la lógica de búsqueda al hacer clic en el botón de búsqueda
    $('#btnBuscar').on('click', function() {
        var valorBusqueda = $('#inputBusqueda').val();

        // Realiza la búsqueda en todas las columnas de la tabla
        $('#multi-filter-select').DataTable().search(valorBusqueda).draw();
    });
});
	...
	?>
		...
		if (mysqli_num_rows($result) > 0) {
			// Si es mayor a cero imprimimos que ya existe la comunidad
		...
		?>
			...
			$sql2 = "INSERT INTO comunidad(nombre_comunidad,provincia)VALUES ('$nombre_comunidad','$provincia')";
				...
				?>
					...
					<script type="text/javascript">
						Swal.fire({
							...
							window.location = "../folder/comunidades.php";
						});
					</script>
