...
<body>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<i class="fas fa-file-medical"></i>
								<p>Detalle Historiales Clinicos</p>
								<span class="caret"></span>
							</a>
												...
												<tbody>
													...
													?>
														<tr>
															...
															<td><?php echo $row['dnidoc']; ?></td>
															<td><?php echo $row['nomdoc']; ?>&nbsp;<?php echo $row['apedoc']; ?></td>
															<td><?php echo $row['sexo']; ?></td>
															<td><?php echo $row['telefo']; ?></td>
															<td><?php echo $row['nombrees']; ?></td>

															<td>
																<?php if ($row['estado'] == 1) { ?>
																	<form method="get" action="javascript:activo('<?php echo $row['coddoc']; ?>')">
																		<button type="submit" class="btn btn-success btn-xs">Activo</button>
																	</form>
																<?php  } else { ?>

																	<form method="get" action="javascript:inactivo('<?php echo $row['coddoc']; ?>')">
	...
	?>
		...
		?>
			...
			$sql2 = "INSERT INTO doctor(dnidoc,nomdoc,apedoc,codespe,sexo,telefo,fechanaci,correo,cargo,estado,usuario,clave)VALUES 
			('$dnidoc','$nomdoc','$apedoc','$codespe','$sexo','$telefo','$fechanaci','$correo','3','1','$usuario','$clave')";
