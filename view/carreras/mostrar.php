...
<body>
	<div class="wrapper">
        ...
        $sql = "SELECT 
    carreras.id, 
    carreras.nombre,  -- alias para el nombre de la carrera
    carreras.semestre, 
    carreras.descripcion,
    turnos.id AS turno_id,              -- id del turno
    turnos.nombre AS turno_nombre       -- alias para el nombre del turno
FROM carreras
LEFT JOIN turnos ON carreras.turno_id = turnos.id
ORDER BY turnos.id;
...
";
    ...
    <td><?php echo $row['nombre']; ?></td> <!-- nombre de la carrera -->
    <td><?php echo $row['semestre']; ?></td>
    <td><?php echo $row['descripcion']; ?></td>
    <td><?php echo $row['turno_nombre']; ?></td>   <!-- nombre del turno -->
       <!-- id del turno si lo necesitas -->
	...
	?>
		...
		?>
			...
			$sql2="INSERT INTO carreras (id, nombre, semestre,  descripcion, turno_id) 
			VALUES ('$id', '$nombre','$semestre',  '$descripcion',  '$turno_id');";	 
				...
				?>
					...
					<script type="text/javascript">
						Swal.fire({
							...
							window.location = "../folder/carreras.php";
						});
					</script>
