										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form  method="POST" action="../view/especialidades/obtener.php?codespe=<?php echo $row['codespe']; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="../view/especialidades/BorrarRegistro.php?codespe=<?php echo $row['codespe']; ?>" class="btn btn-danger"><span class="fa fa-times"></span> Eliminar</a>
            </div>
