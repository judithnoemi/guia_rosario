							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
											<a href="../view/especialidades/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
									...
									<div class="table-responsive">
										...
										<tbody>
											<?php
												...
												$db = $database->open();
												try{	
													$sql = 'SELECT especialidades.codespe,especialidades.nombrees,especialidades.fecha_create  FROM especialidades';
