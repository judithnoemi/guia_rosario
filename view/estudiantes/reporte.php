...
{
// Logo
$this->Image('../../assets/img/Diseño.jpg',10,-1,30);
...
$result = mysqli_query($connString, "SELECT * FROM pacientes") or die("database error:". mysqli_error($connString));
$header = mysqli_query($connString, "SHOW columns FROM pacientes");
