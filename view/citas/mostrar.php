...
session_start();
  ...
  // Vspecialitylidamos que exista una session y ademas que el cargo que exista sea igual a 1 (Administrador)
...
<title>Citas</title>
	...
	<link rel="icon" href="../assets/img/hospi.svg" type="image/x-icon"/>
...
<body>
	...
	<div class="dropdown-title">0 notificaciones</div>
	</li>
	<li>
	</li>
	<li>
	...
	<a href="../view/citas/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
	...
	function activo(codcit)
{
	...
	$.ajax({
        ...
        window.location.href ='../folder/citas.php';
    })
...
$sql = "select * from citas where codcit='$codcit'";
...
$sql2 = "INSERT INTO citas(dates,hour,codpaci,coddoc,codespe,estado)VALUES ('$dates','$hour','$codpaci','$coddoc','$codespe','0')";
