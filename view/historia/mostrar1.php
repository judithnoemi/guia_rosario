...
<body>
						...
						<li class="nav-item active">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
											<a href="../view/historia/mostrarbusquedahistorial.php">
												<span class="sub-item">Busqueda detalle</span>
											</a>
										</li>	
								</ul>
							</div>
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="../view/historia/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
											...
											<table id="add-row" class="display table table-striped table-hover">
												...
												<tbody>
													...
													try {
														...
														ORDER BY historial.idhistoriain';
														foreach ($db->query($sql) as $row) {
													?>
															<tr>
															<td><?php echo $row['idhistoriain']; ?></td>
																...
																<td>
																	<?php if ($row['estado'] == 1) { ?>
																		<form method="get" action="javascript:activo('<?php echo $row['idhistoriain']; ?>')">
																			<button type="submit" class="btn btn-success btn-xs">Activo</button>
																		</form>

																	<?php  } else { ?>
																		<form method="get" action="javascript:inactivo('<?php echo $row['idhistoriain']; ?>')">
																...
																<td>
																	...
																	<div class="form-button-action">
																		<button href="#editRowModal=<?php echo $row['idhistoriain']; ?>" class="btn btn-link btn-primary btn-lg" data-toggle="modal" title="" data-original-title="Edit Task" data-target="#editRowModal<?php echo $row['idhistoriain']; ?>">
																			<i class="fa fa-edit"></i>
																		</button>
																		
																		<button href="#PassRowModal=<?php echo $row['idhistoriain']; ?>" class="btn btn-link btn-primary btn-lg" data-toggle="modal" title="" data-original-title="Pass Task" data-target="#PassRowModal<?php echo $row['idhistoriain']; ?>">
																			<i class="fa fa-key"></i>
																		</button>

																		<button href="#deleteRowModal=<?php echo $row['idhistoriain']; ?>" class="btn btn-link btn-danger btn-lg" data-toggle="modal" title="" data-original-title="Delete Task" data-target="#deleteRowModal<?php echo $row['idhistoriain']; ?>">
	...
	<script>
		function activo(idhistoria) {
			...
			$.ajax({
				...
				window.location.href = '../folder/historia.php';
			})
		}
	...
	if (isset($_POST["agregar"])) {
		...
		$sql = "SELECT * FROM historial where idhistoriain='$idhistoria'";
	...
	?>
		...
		?>
			...
			VALUES ('$codpaci', '$coddoc','$grado_instruccion', '$fecha', '$diagnostico', '$consulta', '$hospital', '1');";	 
				...
				?>
					...
					<script type="text/javascript">
						Swal.fire({
							...
							window.location = "../folder/historia.php";
						});
					</script>
